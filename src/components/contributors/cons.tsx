...
export const ContributorTabs = () => {
  ...
  return (
    <section className="w-full border-t-2 border-black min-h-screen lg:h-[150vh]">
      <div className="md:px-2 lg:px-4 xl:px-16 max-w-[1440px] h-full mx-auto">
        <div className="md:border-x-2 flex flex-col lg:flex-row h-full w-full items-stretch justify-start">
          <div className="w-[15%] h-auto lg:h-full border-r-2 border-black overflow-hidden relative">
            ...
            >
              {contributorsData.map((contributor, index) => (
                <div
                  ...
                  onClick={() => setActiveContributor(contributor)}
                  className="h-[200px] w-[150px] border-y-2 border-r-2 border-black flex flex-col items-center cursor-pointer justify-start"
                >
                  <div className="w-full h-[70%] relative flex justify-center items-end overflow-hidden">
                    <Image
                      src={contributor.image}
            ...
            <div className="flex flex-col items-center justify-end w-[70%] md:w-[50%] lg:w-[70%] h-auto relative">
              ...
              >
                ...
                <div className="absolute -right-6 lg:-right-8 top-1/2 -translate-y-1/2">
                  <Image src={Badge} alt="" className="w-auto" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="w-full lg:w-[50%] flex flex-col">
            <div className="w-full min-h-[40vh] lg:h-[44%] border-b-2 border-black flex items-center justify-center relative py-8 lg:py-0">
              ...
              <div
                ...
                ref={nameRef}
              >
                <h1 className="relative z-20 border text-outline-black mx-4 lg:mx-20 text-[40px] md:text-[50px] lg:text-[60px] uppercase text-center text-white font-inktrap font-extrabold leading-tight">
                  {displayedContributor?.name}
                </h1>
                <h1 className="absolute top-1 border lg:top-2 text-outline-black left-1/2 -translate-x-1/2 z-10 text-[40px] md:text-[50px] lg:text-[60px] uppercase text-center text-[#1B1B1B] font-inktrap font-extrabold leading-tight">
                  {displayedContributor?.name}
                </h1>
                <Image
                  src={Star1}
            ...
            <div ref={marqueeRef} className="h-[10vh] lg:h-[12%]">
              ...
              >
                <div className="flex items-center gap-4 px-4">
                  ...
                  <Image alt="" src={Star3} className="w-6 h-6 lg:w-8 lg:h-8" />
                </div>
            ...
            <div className="w-full min-h-[30vh] lg:h-[44%] bg-black p-6 md:p-8 lg:p-10 flex items-start">
              <p
                ref={descriptionRef}
