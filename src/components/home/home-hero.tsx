  ...
  return (
    <main className="min-h-screen relative flex justify-center items-center border-b-2 border-black">
      <div className="absolute inset-0 h-full w-full">
        <Image src={vortexBg} alt="" className="w-full h-full md:hidden" />
        <Image
          src={vortexLgBg}
          alt=""
      ...
      <div className="relative z-10 text-center pt-[54px] font-neue w-full max-w-[400px] mx-auto md:max-w-[700px] lg:max-w-[1000px] xl:max-w-[1200px]">
        <div className="absolute w-full h-full inset-0">
          <Image
            src={angleBrackets}
            alt=""
            className="absolute top-[154px] -left-4 w-[106px] h-[68px] md:w-[180px] md:h-auto md:top-[85px] lg:w-[285px] lg:h-[182px]"
          />
          <Image
            src={thunder}
            alt=""
            className="absolute top-[154px] -right-4 w-[66px] h-[68px] md:w-[120px] md:h-auto md:top-[85px] lg:w-[151px] lg:h-[155px] lg:right-4"
          />
          <Image
            src={horn}
            alt=""
            className="absolute top-[284px] -left-4 w-[121px] h-[70px] md:w-[230px] md:h-auto md:top-[275px] md:-left-[50px] lg:w-[361px] lg:h-[208px]"
          />
          <Image
            src={cloud}
            alt=""
            className="absolute top-[284px] -right-4 w-[107px] h-[68px] md:w-[190px] md:h-auto md:top-[275px] md:-right-[50px] lg:w-[246px] lg:h-[156px] lg:top-[330px]"
          />
        </div>
        <h1
          className="font-extrabold text-[47px] leading-120p tracking-neg5 text-offblack mb-6 md:text-[80px]"
          style={{
            textShadow:
        ...
        <p
          className="font-extrabold text-[21px] leading-150p tracking-neg5 max-w-[318px] mx-auto mb-6 md:max-w-[500px]"
          style={{
            textShadow:
